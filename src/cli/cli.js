  ...
  constructor(pm2 = false) {
    ...
    this.envVariables = {
      ...
      DEFAULT_APP_ENABLE_CLIENT_MESSAGES:
        "appManager.array.apps.0.enableClientMessages",
      DEFAULT_APP_ENABLED: "appManager.array.apps.0.enabled",
      DEFAULT_APP_MAX_BACKEND_EVENTS_PER_SEC:
        "appManager.array.apps.0.maxBackendEventsPerSecond",
      DEFAULT_APP_MAX_CLIENT_EVENTS_PER_SEC:
        "appManager.array.apps.0.maxClientEventsPerSecond",
      DEFAULT_APP_MAX_READ_REQ_PER_SEC:
        "appManager.array.apps.0.maxReadRequestsPerSecond",
      DEFAULT_APP_USER_AUTHENTICATION:
        "appManager.array.apps.0.enableUserAuthentication",
